                                        ...
                                        <table id="admin_top_table"
                                            ...
                                            @foreach($data as $value)
                                                <tr>
                                                    ...
                                                    <td class="rowDataSd2"><span class="custom-text-long width-128">
                                                        @if ($value->full_status == config('constant.place_is_full'))
                                                            {{ $value->total_place }}{{trans('admin_top.people')}}
                                                        @else
                                                            {{ $value->totalPerson }}{{trans('admin_top.people')}}
                                                        @endif
                                                        </span>
                                                        </td>
                                                    ...
                                                    <td class="rowDataSd4"><span class="custom-text-long width-40">{{ $value->countMale }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd5"><span class="custom-text-long width-40">{{ $value->countFemale }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd6"><span class="custom-text-long width-100">{{ $value->countPregnantWoman }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd7"><span class="custom-text-long width-100">{{ $value->countInfant }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd8"><span class="custom-text-long width-100">{{ $value->countPersonsWithDisabilities }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd9"><span class="custom-text-long width-100">{{ $value->countNursingCareRecipient }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd10"><span class="custom-text-long width-128">{{ $value->countMedicalDeviceUsers }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd11"><span class="custom-text-long width-128">{{ $value->countAllergies }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd12"><span class="custom-text-long width-60">{{ $value->countForeignNationality }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd13"><span class="custom-text-long width-60">{{ $value->countNewbornBaby }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd14"><span class="custom-text-long width-60">{{ $value->countOther }}{{trans('admin_top.people')}}</span></td>
                                                    <td class="rowDataSd15"><span class="custom-text-long width-128">
                                                        @if ($value->full_status == config('constant.place_is_full'))
                                                    ...
                                                    <td data-toggle="modal" class="rowDataSd16 align-middle" data-target="#modal_confirm_change_status_full" data-url="{{ route('admin.changeFullStatus',['id'=> $value->id] ) }}">
