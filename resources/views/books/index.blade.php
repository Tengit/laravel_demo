                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                @foreach ($books as $book)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $book->biography }}</td>
                                        
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $book->address }}</td>
                                        
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $book->birthday }}</td>
                                        
                                        <td class="px-6 py-4 whitespace-nowrap">{{ $book->email }}</td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="/books/create?name={{$book->name}}&biography={{$book->biography}}" class="text-blue-500 hover:text-blue-600">Copy</a>
                                        </td>
