            ...
            <div class="col-2">
                <div class="form-group">
                    <select name="condition" class="form-control">
                        <option value="">---</option>
                        <option value="Old" {{ old('status', request()->input('condition') == 'Old' ? 'selected' : '') }}>Old</option>
                        <option value="New" {{ old('status', request()->input('condition') == 'New' ? 'selected' : '') }}>New</option>
                    </select>
                </div>
            </div>
            <div class="col-2">
                <div class="form-group">
                    <select name="sortBy" class="form-control">
                        ...
                        <option value="title" {{ old('sortBy', request()->input('sortBy') == 'title' ? 'selected' : '') }}>Title</option>
