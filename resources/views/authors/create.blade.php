    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.authors.store") }}" enctype="multipart/form-data" id="crudsAuthorForm">
            ...
            <div class="form-group">
                ...
                <textarea id="biography" name="biography" rows="3" class="form-control summernote {{ $errors->has('biography') ? 'is-invalid' : '' }}">{{ old('biography') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea id="address" name="address" rows="3" class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}">{{ old('address') }}</textarea>
